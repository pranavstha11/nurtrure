const nutritionAppID = "888f09fb";
const nutritionAppKey = "b25852619a493320b2c37dcccc5ab84f";
...
export const setAddInspectFood = (payload) => dispatch => {
  ...
  //Non-Branded
  if (payload.hasOwnProperty('food_name')) {
    let configBody = { "query": payload.food_name };
    fetch(nutritionDetailGeneric, {
      method: 'POST',
      body: JSON.stringify(configBody),
...
//Add extra foods
export const appendExtraFood = (food_name, serving_unit, serving_weight_gram, serving_qty, nf_calories, serving_size, meal_type) => dispatch => {
  let compiledFood = {
    "food_name": food_name,
    "serving_unit": serving_unit,
    "serving_weight_grams": serving_weight_gram,
