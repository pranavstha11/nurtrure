...
//Components
import InspectFoodOverview from '../InspectFood/InspectFoodOverview';
import InspectFoodServings from '../InspectFood/InspectFoodServings';
import InspectFoodMeal from '../InspectFood/InspectFoodMeal';
//Material-UI
...
class InspectFood extends Component {
  constructor(props) {
    ...
    this.inspectFoodRef = React.createRef();
  };

  focusInspectFood = () => {
    this.inspectFoodRef.current.focus();
  }
